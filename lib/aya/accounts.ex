defmodule Aya.Accounts do
  ...
  - User role mappings (identity & audit)

  All schemas in this context reference URM (user_role_mapping) for audit fields.
  """
  ...
  # ── Generated CRUD ──────────────────────────────────────────
  # Each schema gets: fetch_*, get_*, list_*, filter_*, count_*,
  # create_*, update_*, delete_*, etc. (plus bang variants)
  ...
  def get_default_account, do: Repo.get(Account, Aya.Constants.default_account_id())
  ...
  def get_system_user, do: Repo.get(User, Aya.Constants.system_user_id())
  ...
  def get_system_role, do: Repo.get(Role, Aya.Constants.system_role_id())
  ...
  def get_system_urm, do: Repo.get(UserRoleMapping, Aya.Constants.system_urm_id())
